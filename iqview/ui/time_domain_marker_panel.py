...
class TimeDomainMarkerPanel(QFrame):
    interactionModeChanged = pyqtSignal(str) # 'TIME', 'MAG', 'TIME_ENDLESS', 'MAG_ENDLESS', 'ZOOM', 'MOVE'
    ...
    def __init__(self, controller):
        ...
        self.lock_states = {
            'TIME': {'m1': False, 'm2': False, 'delta': False, 'center': False},
            'MAG': {'m1': False, 'm2': False, 'delta': False, 'center': False}
        }
        self.setup_ui()
